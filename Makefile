...
# star __MTS__, RaynorChung: Support 963268, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
# ZyXEL Autumn
...
# star __MTS__, RaynorChung: Support 963268, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
	...
	cd $(PROFILE_DIR); \
	$(HOSTTOOLS_DIR)/bcmZyNandImageBuilder --output $(FS_KERNEL_IMAGE_NAME)_NAND128 --chip $(BRCM_CHIP) --board $(BRCM_BOARD_ID) --internalversion=$(MSTC_INTERNAL_VERSION) --externalversion=$(MSTC_EXTERNAL_VERSION) --modelid=$(MSTC_MODEL_ID) --cmodelid=$(MSTC_CUSTOM_MODEL_ID) --cfefile $(CFE_NAND128_FILE) --rootfsfile rootfs128kb.img --kernelfile vmlinux.lz; \
	$(HOSTTOOLS_DIR)/bcmZyNandImageBuilder --output $(CFE_FS_KERNEL_IMAGE_NAME)_NAND128 --chip $(BRCM_CHIP) --board $(BRCM_BOARD_ID) --internalversion=$(MSTC_INTERNAL_VERSION) --externalversion=$(MSTC_EXTERNAL_VERSION) --modelid=$(MSTC_MODEL_ID) --cmodelid=$(MSTC_CUSTOM_MODEL_ID) --cfefile $(CFE_NAND128_FILE) --rootfsfile rootfs128kb.img --kernelfile vmlinux.lz --include-cfe; \
	...
	$(HOSTTOOLS_DIR)/bcmZyNandImageBuilder --output $(CFE_FS_KERNEL_IMAGE_NAME)_NAND128_TE --chip $(BRCM_CHIP) --board $(BRCM_BOARD_ID) --internalversion=$(MSTC_INTERNAL_VERSION) --externalversion=$(MSTC_EXTERNAL_VERSION) --modelid=$(MSTC_MODEL_ID) --cmodelid=$(MSTC_CUSTOM_MODEL_ID) --cfefile $(CFE_NAND128_FILE_TE) --rootfsfile rootfs128kb.img --kernelfile vmlinux.lz --include-cfe; \
...
BUILD_SWMDK					\
BUILD_IQCTL					\
BUILD_MTS_RESTORE_BTN_PER	\
BUILD_MTS_WPS_BTN_PER		\
BUILD_BACKUP_PSI			\
BUILD_BPMCTL

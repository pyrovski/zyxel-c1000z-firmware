...
enum bp_id {
  ...
  bp_usGpioADSLRED,
  bp_usGpioADSLORANGE,
  bp_usGpioWLANREDFail,
  
  bp_usGpioADSLREDFail,
#endif
...
#if 1//__MSTC__,JhenYang,work around
#else
...
static bp_elem_t g_bcm963268bu[] = {
  ...
  {bp_usGpioOverlay,           .u.ul =(BP_OVERLAY_SERIAL_LEDS | BP_OVERLAY_GPHY_LED_0 |
                                       BP_OVERLAY_PHY |
                                       BP_OVERLAY_USB_LED |
                                       BP_OVERLAY_USB_DEVICE)},
  {bp_usGpioLedAdsl,           .u.us = BP_GPIO_16_AL},
  {bp_usGpioLedSesWireless,    .u.us = BP_GPIO_13_AH},/*__MTS__, Paul Ho, WPS Led */
  {bp_usGpioLedWanData,        .u.us = BP_GPIO_8_AL},
  {bp_usGpioLedWanError,       .u.us = BP_GPIO_14_AH},
  {bp_usGpioLedBlPowerOn,      .u.us = BP_GPIO_20_AL},
  {bp_usGpioLedBlStop,         .u.us = BP_GPIO_21_AL},
  {bp_usExtIntrResetToDefault, .u.us = BP_EXT_INTR_0},
  {bp_usExtIntrSesBtnWireless, .u.us = BP_EXT_INTR_1},
  ...
  {bp_usGpioLedUSB0,            .u.us = BP_GPIO_23_AH},  
#endif
#if 1//__MTS__,JhenYang,LED
  {bp_usGpioWLANRED,            .u.us = BP_GPIO_9_AL},  
  {bp_usGpioWLANORANGE,            .u.us = BP_GPIO_19_AL},  
  {bp_usGpioWPSRED,            .u.us = BP_GPIO_35_AH},  
  {bp_usGpioADSLRED,            .u.us = BP_GPIO_17_AL},  
  {bp_usGpioADSLORANGE,            .u.us = BP_GPIO_18_AL},  
#endif
  {bp_ucDspType0,              .u.uc = BP_VOIP_MIPS},
  {bp_ucDspAddress,            .u.uc = 0},
  {bp_usGpioVoip1Led,          .u.us = BP_SERIAL_GPIO_4_AL},
...
#if 1//__MTSC__,JhenYang, work around
static bp_elem_t * g_BoardParms[] = {g_bcm963268sv1, g_bcm963268mbv, g_bcm963168vx, g_bcm963268bu, g_bcm963268bu_p300, g_bcm963168mbv_17a, g_bcm963168mbv_30a, g_bcm963168xh, g_bcm963168mp, g_bcm963268v30a,   g_bcm963168media, g_bcm963268sv2, g_bcm963168xfg3, g_bcm963168xf, 0};
#else
...
{
    return( BpGetUs(bp_usGpioWLANREDFail, pusValue ) );
} /* BpGetVdslFailLedGpio */
...
{
    return( BpGetUs(bp_usGpioADSLORANGE, pusValue ) );
} /* BpGetVdslLedGpio */

int BpGetADSLREDFailLedGpio( unsigned short *pusValue )
{
    return( BpGetUs(bp_usGpioADSLREDFail, pusValue ) );
} /* BpGetVdslFailLedGpio */
#endif

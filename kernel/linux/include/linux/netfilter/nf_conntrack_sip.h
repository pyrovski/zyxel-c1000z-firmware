...
#define CONFIG_MITRASTAR_SIP_ALG_SESSION_TRACK
#ifdef CONFIG_MITRASTAR_SIP_ALG_SESSION_TRACK //__CTLK__, brianlin
#include <linux/list.h>
typedef struct sip_alg_session_track_s{
	struct list_head list;
	u_int8_t callID[128]; 
	u_int32_t srcIP; /* Internal SIP Agent's IP */
	u_int32_t dstIP; /* Peer SIP */
}sip_alg_session_track_t;
